...
import os
from .ma_trainer import ActorCriticNetwork
...
class BCTrainer:
    ...
    def __init__(self, obs_dim: int = 7, action_dim: int = 1, lr: float = 1e-3):
        self.obs_dim = obs_dim
        self.action_dim = action_dim
        self.lr = lr
        
        # Create network (same architecture as MAPPO)
    ...
    def train(self, dataset_path: str, n_epochs: int = 100, batch_size: int = 64,
              val_split: float = 0.2, save_path: str = "bc_model.pth") -> Dict:
