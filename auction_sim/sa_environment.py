# /auction_sim/sa_environment.py
"""
Single-Agent Auction Environment for k=1 scenario
Fixed reward function to avoid negative training rewards
Reuse the same structure of Multi-Agent Auction Environment to align 
"""
import numpy as np
...
class SingleAgentAuctionEnv:
    """
    Single-Agent Environment wrapper for auction simulation
    Designed for k=1 learning agent competing with rule-based agents
    """
    ...
    def __init__(self, learning_agent_ids: List[str], rule_agents: List[Agent], 
        ...
        self.learning_agent_ids = learning_agent_ids # list including 1 element
        self.rule_agents = rule_agents
        self.n_learning_agents = len(learning_agent_ids) # 1
        self.curriculum_stage = curriculum_stage
        # ======================================================================
        # 注意这里的curriculum stage需要修改
        # ======================================================================
    ...
    def _setup_spaces(self):
        ...
        print(f"Single-Agent Environment initialized:")
        print(f"  - Learning agents: {self.n_learning_agents}") # 1
    ...
    def _build_observation(self, agent_id: str, perceived_value: float) -> np.ndarray:
        ...
        # 6. Opponent win rate
        # len(opponent) = 1, opponent win rate = 0 -> invalid
        ...
        observation = np.array([
            ...
            recent_win_rate,
            recent_profit,
            opponent_win_rate, # in sa env, this item equals 0
            competition_level
        ], dtype=np.float32)
    ...
    # ==============================================================================
    # check the reward if we do not employ curriculum learning to improve the performance of agents
    # ==============================================================================
